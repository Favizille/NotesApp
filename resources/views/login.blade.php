                  ...
                  <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-7 col-xl-6 order-2 order-lg-1">
                      ...
                      <form class="mx-1 mx-md-4" method="POST" action="{{route('logging-in')}}">
                        ...
                        <p class="text-center mb-5 mx-1 mx-md-4 mt-4">Don't have an account? <a href="{{route('register')}}">register</a></p>
                    ...
                    <div class="col-md-10 col-lg-5 col-xl-5 d-flex align-items-center order-1 order-lg-2">
                      ...
                      <img src="{{asset('registerImage.jpg')}}"class="img-fluid" alt="Sample image">
